...
local Win = Library.AddWindown({
	["Name Hub"] = "Reach Hub - Map Build a Boat For Treasure"
})
...
local Toggle = Page.AddToggle({Title = "AutoFarm", Default = false})
Toggle.OnChanged(function(bool)
	_G.AutoFarm = bool
end)

local Toggle = Page.AddToggle({Title = "AntiAFK", Default = false})
Toggle.OnChanged(function(bool)
_G.AntiAFKEnabled = bool
...
local Toggle = Page.AddToggle({Title = "White Screen", Default = false})
Toggle.OnChanged(function(bool)
